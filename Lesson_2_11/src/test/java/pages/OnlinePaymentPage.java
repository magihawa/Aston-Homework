...
public class OnlinePaymentPage {
    ...
    @Step("Получить список логотипов платежных систем")
    ...
    @Step("Проверить, что логотип {alt} виден")
    ...
    @Step("Выбрать тип оплаты: {serviceName}")
    ...
    @Step("Получить название выбранного типа оплаты")
    ...
    @Step("Получить placeholder поля идентификатора")
    ...
    @Step("Ввести значение идентификатора: {value}")
